# FinSight API - Complete Documentation

**Version:** 1.0.0
**Production URL:** https://finsight-api-prod-a25c5600ed94.herokuapp.com
...
FinSight API provides financial data from SEC EDGAR filings with built-in citations, usage tracking, and Stripe billing integration.
...
```bash
curl -X POST https://finsight-api-prod-a25c5600ed94.herokuapp.com/api/v1/auth/register \
...
curl -H "X-API-Key: fsk_xxxxxxxxxxxxxxxxxxxxxxxxx" \
  "https://finsight-api-prod-a25c5600ed94.herokuapp.com/api/v1/companies/search?q=Apple"
```
...
```bash
curl -H "X-API-Key: fsk_xxxxxxxxxxxxxxxxxxxxxxxxx" \
  "https://finsight-api-prod-a25c5600ed94.herokuapp.com/api/v1/metrics?ticker=AAPL&metrics=revenue"
```
...
```bash
curl -H "X-API-Key: fsk_xxx" https://api.finsight.io/v1/metrics?ticker=AAPL
```

**Method 2: Authorization Bearer Header**
```bash
curl -H "Authorization: Bearer fsk_xxx" https://api.finsight.io/v1/metrics?ticker=AAPL
```
...
BASE_URL = "https://finsight-api-prod-a25c5600ed94.herokuapp.com"
...
const BASE_URL = 'https://finsight-api-prod-a25c5600ed94.herokuapp.com';
...
# Get metrics
curl -H "X-API-Key: fsk_xxx" \
  "https://finsight-api-prod-a25c5600ed94.herokuapp.com/api/v1/metrics?ticker=AAPL&metrics=revenue,netIncome"

# Check usage
curl -H "X-API-Key: fsk_xxx" \
  "https://finsight-api-prod-a25c5600ed94.herokuapp.com/api/v1/auth/me"
```
...
**Hosting:** Heroku
**App Name:** `finsight-api-prod`
**URL:** https://finsight-api-prod-a25c5600ed94.herokuapp.com
...
SEC_USER_AGENT=FinSight-API/1.0 (finsight@production.app)
ALLOWED_ORIGINS=*
DEBUG=false
LOG_LEVEL=INFO
...
Check API health:
```bash
curl https://finsight-api-prod-a25c5600ed94.herokuapp.com/health
```
...
**Status Page:** https://finsight-api-prod-a25c5600ed94.herokuapp.com/health
...
For latest updates, visit: https://finsight-api-prod-a25c5600ed94.herokuapp.com/docs
