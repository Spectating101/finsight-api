...
-- GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO finsight_api;
-- GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO finsight_api;
...
VALUES ('demo_user_123', 'demo@finsight.io', 'professional', 'active', 10000)
