...
async def create_key():
    pool = await asyncpg.create_pool("postgresql://localhost/finsight")
...
Your FinSight API is now running. Start monetizing your financial data!

Questions? Email: support@finsight.io
