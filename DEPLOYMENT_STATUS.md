# FinSight API - Deployment Status
...
### Infrastructure
- ✅ **Heroku App:** `finsight-api-prod` (running)
...
### API Endpoints
- ✅ **Root:** https://finsight-api-prod-a25c5600ed94.herokuapp.com/
- ✅ **Docs:** https://finsight-api-prod-a25c5600ed94.herokuapp.com/docs
- ✅ **Health:** https://finsight-api-prod-a25c5600ed94.herokuapp.com/health (503 - Redis issue)
...
- ✅ All tables created:
  ...
  - webhook_events
  - feature_flags
- ✅ Demo user inserted: `demo@finsight.io`
- ✅ Indexes created
- ✅ Triggers configured
...
```bash
cd /home/phyrexian/Downloads/llm_automation/project_portfolio/finsight-api
...
1. Add custom domain (e.g., `api.finsight.io`)
...
# Restart app
heroku restart --app finsight-api-prod

# Open in browser
heroku open --app finsight-api-prod

# Run database query
heroku pg:psql --app finsight-api-prod

# Check dyno status
heroku ps --app finsight-api-prod

# Scale dynos
heroku ps:scale web=1 --app finsight-api-prod
```
...
- **App URL:** https://finsight-api-prod-a25c5600ed94.herokuapp.com
- **API Docs:** https://finsight-api-prod-a25c5600ed94.herokuapp.com/docs
- **GitHub:** /finsight-api (local repo, not pushed yet)
